                ...
                <div class="grid grid-cols-12 gap-3 bg-white p-3 rounded-md mt-2">
                    ...
                    <div class="border-t border-gray-200">
                        <div class="flex flex-col justify-start items-start w-full space-y-1">
                            <div class="flex flex-col justify-start items-start bg-gray-50 py-3 px-6 w-full" v-for="(item, index) in newOrder.orderDetails" :key="index">
...
// const brand = computed<any>(() => (props.id && brandStore.$state.entry ? brandStore.$state.entry : newBrand));
