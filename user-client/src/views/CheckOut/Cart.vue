                ...
                <div class="container">
                    <div class="grid grid-cols-12 gap-3 p-3 bg-white">
                        <div class="col-span-12 lg:col-span-9 p-2">
                            <table
                                class="table bg-white table-cart table-mobile"
                            >
                                <thead>
                                    <tr>
                                        <th>
                                ...
                                <table class="table table-summary">
                                    <tbody>
                                        ...
                                        <tr class="summary-shipping-row">
                                            <td colspan="2">
                                                <select-search
                                                    :listData="shippingUnits"
                                                    display="name"
                                                    keyValue="id"
                                                    v-model="shippingUnitId"
                                                    :firstSelected="true"
                                                ></select-search>
                                            </td>
                                        </tr>
