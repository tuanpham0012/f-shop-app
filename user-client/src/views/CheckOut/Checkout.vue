    ...
    <div class="container-lg" ref="stopPoint">
        ...
        <div class="page-content">
            <div class="cart grid grid-cols-12 gap-3">
                ...
                <div class="col-span-12 p-4 bg-white rounded-lg">
                    <div class="form-floating">
                        <textarea cols="" type="text" class="form-control" style="height: 100px" v-model="orderInfo.note" placeholder="Leave ac comment here"></textarea>
