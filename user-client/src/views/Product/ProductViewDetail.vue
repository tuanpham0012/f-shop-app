      ...
      <div class="col-lg-6">
        ...
        >
          <swiper-slide v-for="(img, index) in product.images"
            ><div
              class="border rounded-3 mb-3 d-flex justify-content-center w-[100] h-auto aspect-square bg-gray-50 d-flex justify-center items-center p-4 box-border"
            >
              <a
            ...
            <div class="col-12">
              <div class="">
                <button class="btn btn-outline-primary py-4"
                  ><span class="text-2xl font-medium"><i class="fa-solid fa-cart-plus"></i> Thêm vào giỏ hàng</span></button
                >

                <div class="details-action-wrapper">
                  <a href="#" class="btn-product btn-wishlist" title="Wishlist"
                    ><span><i class="fa-solid fa-cart-plus"></i>Add to Wishlist</span></a
                  >
