    ...
    <div class="row gx-5">
      ...
      <div class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <div class="d-flex flex-row my-3 text-2xl">
            <div class="text-warning mb-1 me-2 border-r pe-3">
            ...
            <span class="text-muted border-r pe-3"
              ><i class="fas fa-shopping-basket fa-sm mx-1"></i>Đã bán 154</span
            >
            <span class="text-muted border-r pe-3 ps-2"
              ><i class="fa-solid fa-comment-dots fa-sm mx-1"></i>154 Đánh giá</span
            >
                ...
                <div
                  ...
                  :class="{
                    'border-info shadow-2xl shadow-cyan-800/30':
                      selected.findIndex((x) => x.optionValueId == value.id) >=
                      0,
                  }"
